# webChronicle Contributor License Agreement

Here's the short version:

- You (the contributor) are entering into an agreement with the webChronicle project maintainers (FreshJuice).
- You're giving us permission to use and share your contributions (code, docs, fixes).
- You assure us that the contributions are your own and you have the legal right to share them.
- You're not required to support your contributions, but you're welcome to.
- If you ever notice an error in the details you've given us, you agree to let us know.

This agreement lets us distribute your contributions under AGPL-3.0-or-later **and** under other licenses we choose (so we can reuse the code in other projects, including closed-source ones). You keep ownership of your code.

Legally binding section follows:

By submitting a Contribution to the webChronicle project, you hereby accept and agree to the terms and conditions set forth in this Agreement for your present and future Contributions submitted to webChronicle ("Company"). Except for the license granted herein to Company and recipients of software distributed by Company, you reserve all right, title, and interest in and to your Contributions.
